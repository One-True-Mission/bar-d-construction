/* ============================================================
   Bar D Construction & Land Services - site behavior
...
(function () {
  ...
  /* ---------- Quote form: validation + AJAX submit + own redirect ---------- */
  ...
  if (form) {
    ...
    function clearError(el) {
      fieldWrap(el).classList.remove("has-error");
    }
    ...
    function validate() {
      ...
      if (phone) check(phone, phone.value.replace(/\D/g, "").length === 10, "Please enter a 10 digit phone number.");
    ...
    form.addEventListener("submit", function (e) {
      ...
      fetch(form.action, {
        ...
        if (banner) {
          banner.textContent = "Something went wrong sending that. Please try again, or call us at (512) 525-6475.";
